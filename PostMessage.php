...
<body>
    <?php
        ...
        if(isset($_POST["submit"])) {
            ...
            // Check that the file either exists AND has at least one message before continuing
            ...
            } // end of messsage-check if statement

            // check the new subject aganst the ExstngSubjects array
